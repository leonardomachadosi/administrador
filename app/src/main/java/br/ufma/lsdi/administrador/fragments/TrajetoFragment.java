...
import br.ufma.lsdi.administrador.activity.MainActivity;
import br.ufma.lsdi.administrador.adapter.TrajetoAdapter;
...
import br.ufma.lsdi.administrador.service.OnUpdateListener;
    ...
    private OnUpdateListener updateListener() {
        return new OnUpdateListener() {
            ...
            public void onUpdate(UsuarioLocalizacao usuarioLocalizacao) {
                changeFragment(new MapsFragment(), usuarioLocalizacao);
            }
        };
    }
